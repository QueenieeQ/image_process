...
grayscale_image = cv2.imread('../grayscaled.jpg', cv2.IMREAD_GRAYSCALE)

if grayscale_image is None:
    print("Error: Unable to read the image.")
    exit()

# Step 1: Apply edge detection using Canny
edges = cv2.Canny(grayscale_image, 50, 150, apertureSize=3) # Canny has an optional third parameter

# Step 2: Perform Hough Transform to detect lines
...
# Step 4: Display the result with lines drawn
